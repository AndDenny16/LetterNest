...
const DownMenu = () => {
  return (
    <div className=' w-[280px] min-h-screen border-r-2 border-r-green-800 py-2 shadow-[6px_0px_10px_rgba(0,0,0,0.2)] flex flex-col items-start bg-slate-50 font-serif'>
